...
public class InputSiswaMM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_siswa_m_m);
        ...
        adapter = ArrayAdapter.createFromResource(this,R.array.Daftar_Kelas_MM,android.R.layout.simple_spinner_item);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            storageReference1.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    Intent conti= new Intent(InputSiswaMM.this,Home_Admin.class);
