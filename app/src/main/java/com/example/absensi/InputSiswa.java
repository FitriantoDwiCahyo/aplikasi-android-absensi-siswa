...
public class InputSiswa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = ArrayAdapter.createFromResource(this,R.array.Daftar_Kelas_Tkj,android.R.layout.simple_spinner_item);
        ...
        btn_selesai.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SharedPreferences sharedPreferences2 = getSharedPreferences(KELAS_KEY,MODE_PRIVATE);
                SharedPreferences.Editor editor2 = sharedPreferences2.edit() ;
                editor2.putString(kelas_key,outputspinner.getText().toString()+nis_siswa.getText().toString());
                editor2.apply();
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            storageReference1.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    Intent conti= new Intent(InputSiswa.this,Home_Admin.class);
