...
public class InputSiswaAp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_siswa_ap);
        ...
        adapter = ArrayAdapter.createFromResource(this,R.array.Daftar_Kelas_AP,android.R.layout.simple_spinner_item);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            storageReference1.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    Intent conti= new Intent(InputSiswaAp.this,Home_Admin.class);
